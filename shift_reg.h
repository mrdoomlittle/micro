...
void __inline__ shift_reg_reset(struct shift_reg_t *__shift_reg, mdl_u8_t __ps[8]) {bzero(__ps, 8);}
void __inline__ shift_reg_ireset(struct shift_reg_t *__shift_reg) {shift_reg_reset(__shift_reg, __shift_reg-> ps_list);}
